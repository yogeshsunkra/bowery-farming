...
const Footer = () => {
  return (
    <div className="relative flex  items-center justify-center w-full bg-ui-1 overflow-hidden">
      ...
      <div className='relative flex flex-col px-4 py-8  w-full h-full lg:w-[55%] items-center justify-center'>
        ...
        {/* <div className=' self-start '>
          <img src='/footer/footer-mob-l.svg' />
        </div>
        <div className='self-end  bottom-0 '>
          <img src='/footer/footer-mob-r.svg' />
        </div> */}
        {/* <div className='absolute hidden lg:block  bottom-0 '>
      <img src='/footer/footer-bg.svg'/>
      </div> */}
